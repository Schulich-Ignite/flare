# Session 4 Exercise - Terra Firma
# This file platform.py is a pre-built example a class that extends the Pygame sprite class
# You must have platform_tile.png downloaded and placed inside your assets folder to work properly
# Use this class to create platform sprites
...
class Platform(pygame.sprite.Sprite):
    def __init__(self, x, y, width, height):
        ...
        # We replaced the usual line:
        #   self.image = pygame.image.load(os.path.join("assets", "platform_tile.png"))
